...
const StudentSignupPage: React.FC<StudentSignupPageProps> = ({ navigateTo }) => {
                ...
                <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
                    ...
                    <form className="mt-6 space-y-6" onSubmit={handleSignup}>
                        ...
                        <div>
                            ...
                            <div className="mt-1">
                                <input id="password" name="password" type="password" autoComplete="new-password" required className="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-cyan-500 focus:border-cyan-500 sm:text-sm" />
                            </div>
                        </div>
                    ...
                    <div className="mt-6 text-center">
                        <div className="text-sm">
                            ...
                            <p className="mt-2 text-gray-600">
                                Want to teach?{' '}
                                <button onClick={() => navigateTo('become-tutor')} className="font-medium text-cyan-600 hover:text-cyan-500">
                                    Sign up as a tutor
                                </button>
                            </p>
                        </div>
